...
**Pauta vigente:** Pauta general de evaluación, **versión 2**, publicada el 16/09/2026, aplicable a todas las carteras
**Versión anterior:** v1, archivada. Las evaluaciones hechas con ella conservan su pauta y no cambian.
...
## 3. Qué se mide hoy: 87 de 100 puntos

La pauta tiene 15 criterios en 4 bloques que suman 100 puntos. Dos criterios no se pueden medir con lo que hay disponible y quedan declarados como no evaluables.
...
| PECUF | PECUF.3 Declaración escalonada de montos | 5 | Transcripción |
| PECN | PECN.2 Alternativas de pago | 10 | Transcripción |
...
Estos dos criterios **no se aprueban por defecto**. Antes ponían CUMPLE, es decir regalaban el punto; hoy quedan en NO_EVALUABLE y salen del denominador.
...
## 3.1 PECUF.3: declaración escalonada de montos
...
El criterio se renombró a *Declaración escalonada de montos*, su fuente cambió de MULTIFUENTE a TRANSCRIPCIÓN y conserva sus 5 puntos. Vigente desde la v2.
...
Para no descontar dos veces la misma conducta, la v2 separó ambos criterios. PECN.2 dejó de llamarse *Negociación escalonada* —el nombre invitaba a buscar ahí la escalera de montos— y pasó a ser **Alternativas de pago**:
